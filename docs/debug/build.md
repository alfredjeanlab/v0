...
# Close manually or resume build
v0 build {name} --resume
```

## Source Files

- `bin/v0-build:646-1095` — Phase execution
- `lib/hooks/stop-build.sh` — Completion validation
